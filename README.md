    ...
    local Window = Library.CreateLib("Alex", "Synapse")
    ...
    Section:NewButton("Get Zen hub", "ButtonInfo", function()
...
Misc:Toggle("NoClip",_G.NOCLIP,function(value)
 _G.NOCLIP = value
    ...
    local Tab = Window:NewTab("anime adventure")
    local Section = Tab:NewSection("Trap hub")

    Section:NewButton("GetTrap hub", "ButtonInfo", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/TrapstarKSSKSKSKKS/Main/main/Anime%20Adventures.lua"))()
    end)
    local Section = Tab:NewSection("Trap hub v2 ")

    Section:NewButton("Get trap hub v2", "ButtonInfo", function()
